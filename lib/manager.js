...
class QtmProcessManager extends EventEmitter{
	...
	async start(daemons={}) {
		...
		const startupTypeOrder = ['qtmd','mqtt','mysql','pgsql','qtmrovsyncd','qtmrovd', 'gpuminer', 'quantumdagminer','txgen','app'];
		const typeMap = { };
	...
	async stop() {
		//const shutdownTypeOrder = ['qtmd','mqtt','mysql','pgsql','qtmrovsyncd','qtmrovd','simulator','txgen'];
		//const typeMap = { };
...
module.exports = QtmProcessManager;
