...
This is an interim release - due to changes in the Qtm project, the wallet framework functionality is currently disabled, instead you can use the "Console" tab to access the native Qtm CLI wallet.
