...
class QtmInterface {
    ...
    async main() {
        ...
        const methods = proto.QtmdMessage.type.field
        ...
        program
            ...
            .description(`Qtm gRPC client ${pkg.version}`)
...
Please run ${'qtm-rpc help'.yellow} for addition information and examples.        
        `)
        ...
        program
            ...
            .action(async (cmd, options) => {
                ...
                console.log('');
                console.log(`Qtm gRPC client ${pkg.version}`);
                console.log('');
...
Examples:
    ...
    $ ${`rpc --verbose getUtxosByAddresses --addresses=[\\"qtmtest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u\\"]`.yellow}
    ...
    Where file.js can contain: ${`{ addresses : ['qtmtest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u'] }`.yellow}
